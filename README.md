# Mini-app Code Sample
Mini-app is based on 
* [NG6](https://github.com/angularclass/NG6-starter), a starter app for building scalable component-based apps with AngularJS, ES6 and Webpack.
* [Purecss](https://purecss.io/), a set of small, responsive CSS modules.
* [Material Design](https://material.io/icons/), Icons from Google's Material Design.
...
### Running the App
Mini-app uses Gulp to build and launch the development environment. Running `npm start` will bundle the app with `webpack`, launch a development server, and watch all files. The port will be displayed in the terminal.
